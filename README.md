...
> **Status:** early design. The specification is still being written and there is no implementation yet.
...
- [Lifecycle](docs/lifecycle.md) — how a work item is expected to move, and what that requires of the tool.
