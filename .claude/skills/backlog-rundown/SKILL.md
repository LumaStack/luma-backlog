...
<!-- luma-foreman:generated from local/backlog procedure/backlog-rundown. Regenerate with `luma-foreman apply`; edits are lost. -->

# Run down where the work stands

**Read `.luma/bundles/local/backlog/procedure/backlog-rundown.md` and follow it.** That file is the procedure. This is the adapter that makes it reachable from here, and it deliberately carries no copy of it — the copy would drift.
