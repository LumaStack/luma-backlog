...
<!-- luma-foreman:generated from local/backlog procedure/backlog-journal. Regenerate with `luma-foreman apply`; edits are lost. -->

# Write to the journal

**Read `.luma/bundles/local/backlog/procedure/backlog-journal.md` and follow it.** That file is the procedure. This is the adapter that makes it reachable from here, and it deliberately carries no copy of it — the copy would drift.
