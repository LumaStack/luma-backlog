...
defines: work-item
fields:
  workflow_status: {obligation: recommended, field_type: enum, values: [idea, preparing, ready, todo, in_progress, closed], desc: "Where the work is. Absent means the first configured value — idea. Configurable per repository; the tool attaches no meaning to the values."}
