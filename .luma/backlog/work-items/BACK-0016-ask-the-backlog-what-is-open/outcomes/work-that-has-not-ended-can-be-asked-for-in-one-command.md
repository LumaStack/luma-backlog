...
verify_by:
  ...
  - "A record with no status is included, because absence reads as the first work status."
work_item: '[[work-items/BACK-0016-ask-the-backlog-what-is-open]]'
stage: draft
...
evidence:
  - at: "2026-09-08T19:20:56Z"
    by: agent:claude-opus-5/luma-backlog
    what: open 58 + closed 14 = 72 = total; a corpus whose terminal work status was renamed 'finished' still reports 1 of 2 open, so the terminal is derived from the ladder's last value rather than the literal word closed; a record with no status is included
---
