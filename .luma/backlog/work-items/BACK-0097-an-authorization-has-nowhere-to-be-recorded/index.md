...
- **What the tool checks.** Presence, and that the accepting actor is not the
  proposing one --- which is [[work-items/BACK-0098-an-actor-cannot-say-it-has-standing]]'s
...
- **Whether standing can be proven** ---
  [[work-items/BACK-0098-an-actor-cannot-say-it-has-standing]]. This delivers
...
- **Verification verdicts** ---
  [[work-items/BACK-0072-independent-verdicts-cancel-each-other-out]] is about
