...
- **Naming a session** ---
  [[work-items/BACK-0066-an-actor-cannot-name-a-session]] covers telling two
...
- **Where the authorization is written** ---
  [[work-items/BACK-0097-an-authorization-has-nowhere-to-be-recorded]]. That can
