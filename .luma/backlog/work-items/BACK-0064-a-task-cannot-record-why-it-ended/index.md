...
Nothing does.
[[work-items/BACK-0024-two-attempts-at-the-same-task-cannot-both-exist]] is the
...
- **Cheap, and it does not wait on waves.**
  [[work-items/BACK-0019-a-ledger-of-attempts-against-an-outcome]] says the
...
- [[work-items/BACK-0019-a-ledger-of-attempts-against-an-outcome]] — the deeper
  version, blocked on waves.
- [[work-items/BACK-0024-two-attempts-at-the-same-task-cannot-both-exist]] — the
  successor half.
- [[work-items/BACK-0031-reshape-the-command-surface]] — its journal is where
