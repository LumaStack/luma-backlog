...
**[[work-items/BACK-0066-an-actor-cannot-name-a-session]] is upstream of every
...
- [[work-items/BACK-0013-how-two-workstations-avoid-colliding]] — names
  colliding, where this is state going stale.
- [[work-items/BACK-0066-an-actor-cannot-name-a-session]] — the blocker.
- [[work-items/BACK-0074-an-active-work-item-remembered-outside-the-repository]]
  — the state that deliberately does not synchronize.
- [[work-items/BACK-0059-how-ad-hoc-work-should-be-done]] — the twelve-hour
