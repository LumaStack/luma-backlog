...
rank: 070.0190.000
modified: {by: 'agent:claude-opus-5/luma-backlog', at: '2026-09-17T15:17:29Z'}
closed: {on: 2026-09-17, as: completed, by: 'agent:claude-opus-5/luma-backlog', reason: 'every work item carries a rank, placement follows direction, and repair exists --- three outcomes proven against checks written before the work'}
former_keys: ["WORK-0095"]
---
...
- **Whether closed records stay in the corpus at all** ---
  [[work-items/BACK-0039-what-closed-work-items-cost-as-the-corpus-grows]]. If
  they are archived the listing gets shorter; how they sort while present is
  still this record's question.
- **`rank --at <n>`** --- [[work-items/BACK-0021-rank-by-position-rather-than-by-neighbor]],
...
[[work-items/BACK-0040-a-decision-number-is-reused-when-its-file-is-absent]]
