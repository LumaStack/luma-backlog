...
[[work-items/BACK-0013-how-two-workstations-avoid-colliding]], settled for
repair by
...
[[work-items/BACK-0059-how-ad-hoc-work-should-be-done]]. Let the agent make the
call, record that it made one, make it reviewable.
[[work-items/BACK-0060-a-configurable-menu-of-working-modes]] holds the protocol:
...
- [[work-items/BACK-0060-a-configurable-menu-of-working-modes]] — the protocol
  for letting an agent make a call and recording that it did.
- [[work-items/BACK-0013-how-two-workstations-avoid-colliding]] — colliding
