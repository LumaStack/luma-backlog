...
- **A way to confirm there was no collision** — detection rather than allocation, useful immediately, and independent of which scheme wins. Split out as [[work-items/BACK-0014-detect-two-records-holding-one-key]].
