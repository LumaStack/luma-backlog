# Journal — Give every work item a key and an id
...
directories now carry the key — recovered from a stray directory that journal -w created before it resolved its argument
...
backfilled the twelve existing work items in creation order, so BACK-0001 is first-usable-build
