...
[[work-items/BACK-0065-blocked-is-a-flag-rather-than-a-rung]] the neighbouring
...
- **Complete versus delivered** — a re-open of ADR-0007, independent of how
  ...
  [[work-items/BACK-0069-the-backlog-has-no-unit-for-a-delivery]], which asks for
...
- [[work-items/BACK-0065-blocked-is-a-flag-rather-than-a-rung]] — the shape a
  step that names what it blocks would take.
- [[work-items/BACK-0032-how-goalpost-fitting-is-discouraged-without-being-prevented]]
  — where the cost of requiring outcomes early lands.
- [[work-items/BACK-0069-the-backlog-has-no-unit-for-a-delivery]] — a unit for a
  delivery, where this touches a status for one.
- [[records/decisions/ADR-0009-a-symbol-that-must-mean-one-thing-is-assigned-in-one-place]]
  — one assignment point for any name this produces.
- [[work-items/BACK-0074-an-active-work-item-remembered-outside-the-repository]]
  — its journal is the worked example of naming against a spent vocabulary.
- [[work-items/BACK-0060-a-configurable-menu-of-working-modes]] — the other
