...
[[backlog/work-items/BACK-0022-migrate-a-corpus-when-the-vocabulary-changes]]
handles a vocabulary rename;
[[backlog/work-items/BACK-0036-whether-stage-is-used-correctly-or-removed]]
...
- `[[backlog/work-items/BACK-0031-reshape-the-command-surface]]` — the changes
...
2. **The username replacement** --- actor values written from the operating
   system user
   ([[work-items/BACK-0035-the-operating-system-username-must-never-be-an-actor]]).
...
4. **The command surface**
   ([[work-items/BACK-0031-reshape-the-command-surface]]) --- `delivered`
