...
numbering continues across a prefix change — BACK-0103 followed BACK-0102 — because the corpus keeps one sequence (highestKey's own comment: a spoken number has to mean one record). restarting at 1 was never seriously on the table
the capture's open question (init-only or changeable later) answered itself: changeable any time, because BACK-0082 made mixed prefixes readable first. order mattered — recognition before configurability meant no migration was forced
