...
**Reporting the skip at all.** That is [[work-items/WORK-00008-report-what-a-listing-skipped]], which this depends on: the arithmetic cannot react to a skip that `List` never returns.
