# Journal — Separate quick capture from thoughtful capture
...
BACK-0029-separate-quick-capture-from-thoughtful-capture unprepared → captured: sent back to the pile so there is one place to choose from; this had crossed the first gate and that decision is being re-made rather than lost
