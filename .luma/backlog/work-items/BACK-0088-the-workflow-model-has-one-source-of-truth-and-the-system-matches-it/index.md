...
- **Six of nineteen rows in the work status table are not built** — two `stage` writes
  ([[work-items/BACK-0075-a-move-does-not-write-the-stage-it-promises]]), an
  owner and a per-worker limit
  ([[work-items/BACK-0066-an-actor-cannot-name-a-session]]), an unsuccessful-task
  warning ([[work-items/BACK-0064-a-task-cannot-record-why-it-ended]]), and
...
- **Three work statuses are recognised by position, not by name.** The pile, the shaping
  ...
  ([[work-items/BACK-0083-finalize-the-vocabulary-for-the-workflow-model]]).
...
- `docs/workflow-status.md`, `docs/spec.md` §2.2.1 §4.2 §9 — the normative
  sources today.
- [[records/decisions/ADR-0002-the-workflow-ladder-is-two-pipelines-behind-two-gates]]
- [[work-items/BACK-0083-finalize-the-vocabulary-for-the-workflow-model]] — the
