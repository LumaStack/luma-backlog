...
settled by the maintainer: inline carries the substance by position and needs nothing more, a footer has no position so it must reference the point — which is why 'journaled on BACK-0031' fails as a footer and would have been fine inline
