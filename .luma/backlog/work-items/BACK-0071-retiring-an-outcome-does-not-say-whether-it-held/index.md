...
- [[work-items/BACK-0036-whether-stage-is-used-correctly-or-removed]] — what
  `stage` is for, which this deliberately does not touch.
- [[work-items/BACK-0031-reshape-the-command-surface]] — `outcome archive` is
