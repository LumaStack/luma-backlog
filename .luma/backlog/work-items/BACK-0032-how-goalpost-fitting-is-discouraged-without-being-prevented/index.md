...
[[backlog/work-items/BACK-0018-extract-the-application-layer]] finished its work
...
| --- | --- | --- |
| **No outcomes** | `close … delivered` is refused; `--force` overrides and leaves a permanent mark on the record ([[records/decisions/ADR-0007-an-outcome-carries-the-doer-s-assertion-and-the-checker-s-verdict-separately]]) | **The refusal, yes. `--force`, no** — it is specified and unbuilt ([[backlog/work-items/BACK-0031-reshape-the-command-surface]]) |
...
[[backlog/work-items/BACK-0018-extract-the-application-layer]] hit exactly that.
...
[[backlog/work-items/BACK-0026-what-deserves-to-be-a-work-item]] — whether
