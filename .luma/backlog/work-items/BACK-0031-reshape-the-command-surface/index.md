...
([[backlog/work-items/BACK-0017-specify-the-minimum-viable-product]]). **The
code is what changes.**

Split out of
[[backlog/work-items/BACK-0018-extract-the-application-layer]] deliberately.
...
**[[work-items/BACK-0043-work-the-backlog-from-a-terminal]]** took five tasks:
...
**[[work-items/BACK-0022-migrate-a-corpus-when-the-vocabulary-changes]]** took
