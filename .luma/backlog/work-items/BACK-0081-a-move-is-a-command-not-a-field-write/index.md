...
[[work-items/BACK-0073-closing-through-set-skips-every-check-close-performs]] —
`set workflow_status=closed` skips the outcome gate, the disposition, the
`closed` event and the `--force` requirement.
[[work-items/BACK-0075-a-move-does-not-write-the-stage-it-promises]] — the move
...
[[work-items/BACK-0075-a-move-does-not-write-the-stage-it-promises]] for the
guarantees and
...
[[work-items/BACK-0021-rank-by-position-rather-than-by-neighbor]] deferred
...
- [[work-items/BACK-0075-a-move-does-not-write-the-stage-it-promises]] — the
  guarantees that need somewhere to live.
- [[work-items/BACK-0021-rank-by-position-rather-than-by-neighbor]] — why
