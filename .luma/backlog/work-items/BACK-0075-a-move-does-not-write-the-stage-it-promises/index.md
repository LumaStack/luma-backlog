...
- *"Closing sets `stage` to `stable`. The content is not expected to change much
  afterwards."*
- The work status table: `closed` → *"`stage` becomes `stable`"* — **written by the
...
[[work-items/BACK-0036-whether-stage-is-used-correctly-or-removed]], and it has
...
- [[work-items/BACK-0036-whether-stage-is-used-correctly-or-removed]] — decides
...
- [[work-items/BACK-0059-how-ad-hoc-work-should-be-done]] — where this was
