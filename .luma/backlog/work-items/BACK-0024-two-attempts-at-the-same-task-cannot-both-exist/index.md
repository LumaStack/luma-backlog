...
| **A key of its own for tasks and outcomes** | Set aside separately in `[[backlog/work-items/BACK-0023-refer-to-a-record-by-the-path-a-person-would-type]]` — references are always work-item-scoped, so global uniqueness buys nothing. |
