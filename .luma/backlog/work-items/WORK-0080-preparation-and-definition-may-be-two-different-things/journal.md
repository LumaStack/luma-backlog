...
so this may be two fields rather than one — which is the same shape as status-versus-rank and owner-versus-worker, both of which were found by trying to make one field carry two axes. see WORK-0036, where the same proposal lands as a job for stage
