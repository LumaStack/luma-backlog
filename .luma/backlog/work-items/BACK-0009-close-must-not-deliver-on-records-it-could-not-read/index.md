...
**Reporting the skip at all.** That is [[work-items/BACK-0008-report-what-a-listing-skipped]], which this depends on: the arithmetic cannot react to a skip that `List` never returns.
