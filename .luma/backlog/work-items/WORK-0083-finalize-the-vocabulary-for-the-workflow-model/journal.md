...
and the naming landed on bare status — state claims more than the field holds, since a record's state is the whole record while its status is where it stands in a process. that is WORK-0089 now, with the survey of twenty tools in its body
