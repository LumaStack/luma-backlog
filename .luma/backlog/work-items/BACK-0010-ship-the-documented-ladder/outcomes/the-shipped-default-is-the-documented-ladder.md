...
evidence:
  - at: "2026-09-04T17:40:11Z"
    by: agent:claude-opus-5/luma-backlog
    what: 'In a fresh repository, new work-item writes workflow_status: captured, and the scaffolded config lists the seven work statuses identically to the compiled default. No record under .luma/ carries idea or ready. Golden diff was four substitutions and nothing else; go test ./... green.'
---
