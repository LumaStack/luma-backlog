...
THIRD INSTANCE in a row: WORK-0091 is an idea about a project-wizard bundle, which belongs to luma-catalog and was captured here. three consecutive ideas have now been filed in the wrong project's corpus, which is the strongest evidence this record has
FOURTH INSTANCE: WORK-0093 is an idea about luma-foreman, a third project — not this one, not luma-catalog. four consecutive ideas now filed in the wrong corpus, spanning three destinations
...
which means moving a record between projects has a prerequisite nobody had named: the destination needs a corpus, and creating one is a decision about whether that project keeps a backlog at all. that is WORK-0070, and it sits in front of this rather than beside it
