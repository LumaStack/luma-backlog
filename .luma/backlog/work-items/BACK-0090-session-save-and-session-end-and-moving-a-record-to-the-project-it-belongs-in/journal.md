...
CHECKED rather than assumed, 2026-09-10: luma-foreman and luma-catalog are both checked out alongside this repository, one directory from here. both have .luma/ and NEITHER has .luma/backlog/ — so there is no corpus in either to file a record into
