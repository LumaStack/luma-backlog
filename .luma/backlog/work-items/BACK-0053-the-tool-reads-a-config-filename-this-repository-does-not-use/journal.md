...
the fix was one constant plus deleting the twin. the rename was free because no other repository uses the tool yet (BACK-0070) — the window BACK-0037 warned about, used before it closes
